...
p{margin-left:4em;}. @~/Documents/Processing/libraries/@
...
p{margin-left:4em;}. File > Sketchbook > libraries > ciao > examples
...
p{margin-left:4em;}. @~/Documents/Arduino/libraries/@
...
p{margin-left:4em;}. File > Examples > CiaoUSB

4. Launch Processing and load the CiaoArduino example:

p{margin-left:4em;}. File > Sketchbook > libraries > ciao > examples > CiaoArduino
...
p{margin-left:4em;}. File > Examples > Ciao
...
p{margin-left:4em;}. @Ciao.begin("BlinkM", SERVER_PORT);@
...
p{margin-left:4em;}. @Ciao.addDisplay(char* label);@
...
p{margin-left:4em;}. @Ciao.addDisplay("Value");@

If the Arduino then sends a line that looks like this:

p{margin-left:4em;}. @Value 25@
...
p{margin-left:4em;}. @addButton(char *label);@
...
p{margin-left:4em;}. @Ciao.addButton("Up");@
...
p{margin-left:4em;}. @addButton(char *label, char *send);@

For example, BetterBlinkM.pde calls:

p{margin-left:4em;}. @Ciao.addButton("Red", "red");@
...
p{margin-left:4em;}. @label3=Green@
@send3=green@
@label4=Blue@
@send4=blue@
